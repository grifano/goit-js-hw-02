...
Вона оголошує три параметри, значення яких будуть 
...
"You ordered <quantity> droids worth <totalPricePrice> credits!", 
де <quantity> це кількість замовлених дроїдів, а <totalPricePrice> 
це їх загальна вартість.
 */

function makeTransaction(quantity, pricePerDroid, customerCredits) {
  const totalPrice = quantity * pricePerDroid;
  const isAbleToPay = totalPrice > customerCredits;
